...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lrStartLabel.setText(_translate("MainWindow", "Начальная скорость"))
        self.lrEdit.setPlaceholderText(_translate("MainWindow", "0.1"))
        self.lrFinalLabel.setText(_translate("MainWindow", "Конечная скорость"))
        self.lrFinalEdit.setPlaceholderText(_translate("MainWindow", "0.001"))
        self.decayLabel.setText(_translate("MainWindow", "Способ снижения"))
        self.epochsLabel.setText(_translate("MainWindow", "Кол-во эпох"))
        self.epochsEdit.setPlaceholderText(_translate("MainWindow", "1000"))
        self.queryLabel.setText(_translate("MainWindow", "Кол-во опросов"))
        self.queryEdit.setPlaceholderText(_translate("MainWindow", "10"))
        self.batchSizeLabel.setText(_translate("MainWindow", "Размер пакета"))
        self.batchSizeEdit.setPlaceholderText(_translate("MainWindow", "64"))
        self.stoppingLabel.setText(_translate("MainWindow", "Предв. остановка"))
        self.printLabel.setText(_translate("MainWindow", "Промеж. рез-ты"))
        self.plotsLabel.setText(_translate("MainWindow", "Графики"))
        self.lossLabel.setText(_translate("MainWindow", "Функция потерь"))
        self.optimizerLabel.setText(_translate("MainWindow", "Оптимизатор"))
